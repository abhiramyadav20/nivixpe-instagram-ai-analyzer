...
```bash
git clone https://github.com/your-username/instagram-enhanced.git
...
- **OpenAI key** → [platform.openai.com/api-keys](https://platform.openai.com/api-keys) — transcription costs ~$0.006/min
...
3. Gemini 1.5 Pro returns: themes that are working, themes to stop, 5 specific reel ideas with hooks
...
│       ├── content-ideas/        # Gemini 1.5 Pro strategy
